...
public class Declaration {
    public static void main(String[] args) throws IOException {
        ...
        params.add(new BasicNameValuePair("customs", "ZONGSHU"));
        params.add(new BasicNameValuePair("mch_customs_no", "xxxxxx"));
        params.add(new BasicNameValuePair("merchant_customs_name", "xxxx公司"));
        params.add(new BasicNameValuePair("sub_order_no", "your_sub_order_no"));
        params.add(new BasicNameValuePair("sub_order_amount", "100"));
